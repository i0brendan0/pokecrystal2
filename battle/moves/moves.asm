...
ENDM
;        NAME          EFFECT                  POWER  TYPE      ACC  PP EFF%
	...
	move BIND,         EFFECT_BIND,               15, NORMAL,    85, 20,   0
	...
	move WRAP,         EFFECT_BIND,               15, NORMAL,    90, 20,   0
	...
	move FIRE_SPIN,    EFFECT_BIND,               35, FIRE,      85, 15,   0
	...
	move CLAMP,        EFFECT_BIND,               35, WATER,     85, 15,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,   100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        130, GROUND,   100, 10,   0
	...
	move GLARE,        EFFECT_PARALYZE,            0, DARK,     100, 30,   0
