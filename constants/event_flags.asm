...
; Pokecrystal2 Events
	const EVENT_BEAT_RED;105
	const EVENT_SAW_MISSINGNO;106
	const EVENT_GOT_HONEY;107
	const EVENT_KAREN_DARK_BOOST;108
	const EVENT_FOUGHT_ZAPDOS;109
	const EVENT_FOUGHT_MOLTRES;10A
	const EVENT_FOUGHT_ARTICUNO;10B
	const EVENT_LEGENDARY_BIRD_ZAPDOS;10C
	const EVENT_LEGENDARY_BIRD_MOLTRES;10D
	const EVENT_LEGENDARY_BIRD_ARTICUNO;10E
	const EVENT_FOUGHT_MEWTWO;10F
	const EVENT_LEGENDARY_MEWTWO;110
	const EVENT_TOLD_ABOUT_FARAWAY_ISLAND;111
	const EVENT_OLIVINE_PORT_MAP_SAILOR;112
	const EVENT_FOUGHT_MEW;113
	const EVENT_FARAWAY_ISLAND_MAP_SAILOR;114
	const EVENT_LEGENDARY_MEW;115
	const EVENT_116
	const EVENT_117
	const EVENT_118
	const EVENT_119
...
; Johto Gym Leader Rematches
	const EVENT_BEAT_FALKNER_REMATCH;200
	const EVENT_BEAT_BUGSY_REMATCH;201
	const EVENT_BEAT_WHITNEY_REMATCH;202
	const EVENT_BEAT_MORTY_REMATCH;203
	const EVENT_BEAT_JASMINE_REMATCH;204
	const EVENT_BEAT_CHUCK_REMATCH;205
	const EVENT_BEAT_PRYCE_REMATCH;206
	const EVENT_BEAT_CLAIR_REMATCH;207
; Kanto Gym Leader Rematches
	const EVENT_BEAT_BROCK_REMATCH;208
	const EVENT_BEAT_MISTY_REMATCH;209
	const EVENT_BEAT_LTSURGE_REMATCH;20A
	const EVENT_BEAT_ERIKA_REMATCH;20B
	const EVENT_BEAT_JANINE_REMATCH;20C
	const EVENT_BEAT_SABRINA_REMATCH;20D
	const EVENT_BEAT_BLAINE_REMATCH;20E
	const EVENT_BEAT_BLUE_REMATCH;20F
; ???
	const EVENT_210
	const EVENT_211
	const EVENT_212
