...
.Warps: db 2
	warp_def 7, 6, 7, OLIVINE_CITY
	warp_def 7, 7, 7, OLIVINE_CITY
...
.ObjectEvents: db 11
	person_event SPRITE_SAILOR, 3, 8, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, SailorScript_0x9c8c1, -1
	person_event SPRITE_FISHING_GURU, 3, 11, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, FishingGuruScript_0x9c8d9, -1
	person_event SPRITE_SAILOR, 6, 10, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, SailorScript_0x9c8dc, -1
