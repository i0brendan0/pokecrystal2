	...
	map_header_2 CherrygroveCity, CHERRYGROVE_CITY, 53, NORTH | EAST
	...
	map_header_2 CianwoodCity, CIANWOOD_CITY, 53, EAST
	...
	map_header_2 MahoganyTown, MAHOGANY_TOWN, 113, NORTH | WEST | EAST
	...
	map_header_2 SilverCaveOutside, SILVER_CAVE_OUTSIDE, 44, EAST
	...
	map_header_2 Route40, ROUTE_40, 53, SOUTH | EAST
	...
	map_header_2 Route44, ROUTE_44, 113, WEST | EAST
	...
	map_header_2 Route22, ROUTE_22, 44, EAST
	connection east, VIRIDIAN_CITY, ViridianCity, -3, 1, 15, ROUTE_22

	map_header_2 Route1, ROUTE_1, 15, NORTH | SOUTH
	...
	map_header_2 Route21, ROUTE_21, 67, NORTH | SOUTH
	...
	map_header_2 Route5, ROUTE_5, 15, NORTH | SOUTH
	...
	map_header_2 Route10South, ROUTE_10_SOUTH, 44, NORTH | SOUTH
	...
	map_header_2 IcePathB2FMahoganySide, ICE_PATH_B2F_MAHOGANY_SIDE, 25, 0
	map_header_2 IcePathB2FBlackthornSide, ICE_PATH_B2F_BLACKTHORN_SIDE, 25, 0
	...
	map_header_2 WhirlIslandSE, WHIRL_ISLAND_SE, 15, 0
	map_header_2 WhirlIslandB1F, WHIRL_ISLAND_B1F, 9, 0
	map_header_2 WhirlIslandB2F, WHIRL_ISLAND_B2F, 46, 0
	map_header_2 WhirlIslandLugiaChamber, WHIRL_ISLAND_LUGIA_CHAMBER, 15, 0
	...
	map_header_2 DragonsDenB1F, DRAGONS_DEN_B1F, 113, 0
	...
	map_header_2 GoldenrodDeptStoreRoof, GOLDENROD_DEPT_STORE_ROOF, 36, 0
	...
	map_header_2 OlivinePort, OLIVINE_PORT, 10, 0
	map_header_2 VermilionPort, VERMILION_PORT, 10, 0
	...
	map_header_2 MountMoonSquare, MOUNT_MOON_SQUARE, 45, 0
	...
	map_header_2 SilverCaveMoltresRoom, SILVER_CAVE_MOLTRES_ROOM, 9, 0
	map_header_2 SeafoamIslandB1F, SEAFOAM_ISLAND_B1_F, 9, 0
	map_header_2 SafariZone2, SAFARI_ZONE_2, 0, 0
	connection east, SAFARI_ZONE_BETA, SafariZoneBeta, 0, 0, 14, SAFARI_ZONE_2

	map_header_2 SafariZone3, SAFARI_ZONE_3, 0, 0
	connection west, SAFARI_ZONE_BETA, SafariZoneBeta, 0, 0, 14, SAFARI_ZONE_3

	map_header_2 CeruleanCave, CERULEAN_CAVE, 9, 0
	map_header_2 FarawayIslandOutside, FARAWAY_ISLAND_OUTSIDE, 67, 0
	map_header_2 FarawayIslandCave, FARAWAY_ISLAND_CAVE, 9, 0
